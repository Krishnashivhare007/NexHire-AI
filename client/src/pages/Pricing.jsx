...
function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-16 px-6">
      <div className="max-w-6xl m-auto mb-14 flex items-start gap-4">
        <button
          onClick={() => navigate("/")}
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {/* Default tag */}
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-50 text-gray-700 text-xs px-3 py-1 rounded-full">
                  Default
                </div>
              )}
